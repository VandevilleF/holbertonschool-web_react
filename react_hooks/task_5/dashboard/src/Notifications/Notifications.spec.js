...
describe('Notifications component', () => {
  ...
  test('displays updated content when notification content changes (same length)', () => {
    ...
    expect(screen.getByText('Notification 1 updated')).toBeInTheDocument();
    expect(screen.getByText('Notification 2 updated')).toBeInTheDocument();
  });

  test('displays new notification when notifications length increases', () => {
    const initialNotifications = [
      { id: 1, type: 'default', value: 'Notification 1' },
    ];
